...
/* for web failsafe mod , added by kyson<luoweilong@gl-inet.com> */
#include "httpd.h"
...
#if 1 /* Proccess browser http request, add by kyson<luoweilong@gl-inet.com> */
